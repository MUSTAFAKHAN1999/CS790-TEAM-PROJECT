...
class Fork implements org.jcsp.lang.CSProcess {

  private final org.jcsp.lang.AltingChannelInput[] fromPhil;

  Fork(org.jcsp.lang.AltingChannelInput l, org.jcsp.lang.AltingChannelInput r) { 
    fromPhil = new org.jcsp.lang.AltingChannelInput[] { l, r }; 
  }

  public void run() {
    org.jcsp.lang.Alternative alt = new org.jcsp.lang.Alternative(fromPhil);
...
class Butler implements org.jcsp.lang.CSProcess {

  private final org.jcsp.lang.AltingChannelInput[] enters;
  private final org.jcsp.lang.AltingChannelInput[] exits;

  Butler(org.jcsp.lang.AltingChannelInput[] e, org.jcsp.lang.AltingChannelInput[] x) {
    enters = e;
    exits = x;
  }
  ...
  public void run() {
    ...
    org.jcsp.lang.AltingChannelInput[] chans = new org.jcsp.lang.AltingChannelInput[2*seats];
    for (int i = 0; i < seats; ++i) {
      chans[i] = exits[i];
      chans[seats + i] = enters[i];
    }

    org.jcsp.lang.Alternative either = new org.jcsp.lang.Alternative(chans);
    org.jcsp.lang.Alternative exit = new org.jcsp.lang.Alternative(exits);

    for (;;) {   
      // if max number are seated, only allow exits
      org.jcsp.lang.Alternative alt = (nseated <  seats-1)? either : exit;
...
class Philosopher implements org.jcsp.lang.CSProcess {

  private final org.jcsp.lang.ChannelOutput leftFork;
  private final org.jcsp.lang.ChannelOutput rightFork;
  private final org.jcsp.lang.ChannelOutput enter;
  private final org.jcsp.lang.ChannelOutput exit;

  Philosopher(org.jcsp.lang.ChannelOutput l, org.jcsp.lang.ChannelOutput r,
              org.jcsp.lang.ChannelOutput e, org.jcsp.lang.ChannelOutput x) {
    leftFork = l; 
    rightFork = r;
    enter = e; 
    exit = x;
...
class College implements org.jcsp.lang.CSProcess {
  final static int N = 5;

  private final org.jcsp.lang.CSProcess action;

  College() {
    org.jcsp.lang.One2OneChannel[] lefts = org.jcsp.lang.One2OneChannel.create(N);
    org.jcsp.lang.One2OneChannel[] rights = org.jcsp.lang.One2OneChannel.create(N);
    org.jcsp.lang.One2OneChannel[] enters = org.jcsp.lang.One2OneChannel.create(N);
    org.jcsp.lang.One2OneChannel[] exits = org.jcsp.lang.One2OneChannel.create(N);
    ...
    action = new org.jcsp.lang.Parallel(
      new org.jcsp.lang.CSProcess[] {
        butler,
        new org.jcsp.lang.Parallel(phils),
        new org.jcsp.lang.Parallel(forks)
      });
  }
